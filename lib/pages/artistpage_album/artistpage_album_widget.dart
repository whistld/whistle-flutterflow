...
import 'artistpage_album_model.dart';
export 'artistpage_album_model.dart';

class ArtistpageAlbumWidget extends StatefulWidget {
  const ArtistpageAlbumWidget({
    super.key,
    String? artistName,
    this.artistID,
    this.albumref,
  ...
  @override
  State<ArtistpageAlbumWidget> createState() => _ArtistpageAlbumWidgetState();
}

class _ArtistpageAlbumWidgetState extends State<ArtistpageAlbumWidget> {
  late ArtistpageAlbumModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArtistpageAlbumModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.artistName = widget.artistName;
        _model.artistID = widget.artistID;
      });
    });
  }
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Date: ${dateTimeFormat('d/M/y', listViewAlbumsRecord.dateOfCreation)}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                              .override(
