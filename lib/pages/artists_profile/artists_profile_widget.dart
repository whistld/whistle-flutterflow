...
import 'artists_profile_model.dart';
export 'artists_profile_model.dart';

class ArtistsProfileWidget extends StatefulWidget {
  const ArtistsProfileWidget({super.key});

  @override
  State<ArtistsProfileWidget> createState() => _ArtistsProfileWidgetState();
}

class _ArtistsProfileWidgetState extends State<ArtistsProfileWidget> {
  late ArtistsProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArtistsProfileModel());
