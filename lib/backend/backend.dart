...
import 'schema/music_genre_record.dart';
import 'schema/instruments_record.dart';
...
export 'schema/music_genre_record.dart';
export 'schema/instruments_record.dart';
...
/// Functions to query MusicGenreRecords (as a Stream and as a Future).
Future<int> queryMusicGenreRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      MusicGenreRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<MusicGenreRecord>> queryMusicGenreRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      MusicGenreRecord.collection,
      MusicGenreRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<MusicGenreRecord>> queryMusicGenreRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query InstrumentsRecords (as a Stream and as a Future).
Future<int> queryInstrumentsRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      InstrumentsRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<InstrumentsRecord>> queryInstrumentsRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InstrumentsRecord.collection,
      InstrumentsRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<InstrumentsRecord>> queryInstrumentsRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
